...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        return client.sendTime(message.channel, `<:check:774976288610975764> | **Bassboost level set to** \`${level}\``);
    },
    SlashCommand: {
        options: [
            {
        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            return client.sendTime(interaction, `<:check:774976288610975764> | **Set the bassboost level to** \`${level}\``);
        },
    },
};
